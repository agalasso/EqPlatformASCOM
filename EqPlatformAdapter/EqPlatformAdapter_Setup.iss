...
; Generated by Andy Galasso on 3/28/2018 (UTC)
;
[Setup]
AppID={{aec893c7-b4f2-4160-aa3d-ed5d8ced2cc6}
AppName=ASCOM EqPlatformAdapter Telescope Driver
AppVerName=ASCOM EqPlatformAdapter Telescope Driver 6.0.2
AppVersion=6.0.2
AppPublisher=Andy Galasso  <andy.galasso@gmail.com> and Thomas Beck
AppPublisherURL=mailto:andy.galasso@gmail.com
...
OutputDir="."
OutputBaseFilename="EqPlatformAdapter Setup"
Compression=lzma
SolidCompression=yes
; Put there by Platform if Driver Installer Support selected
WizardImageFile="C:\Program Files (x86)\ASCOM\Platform 6 Developer Components\Installer Generator\Resources\WizardImage.bmp"
LicenseFile="..\COPYING.LESSER.txt"
; {cf}\ASCOM\Uninstall\Telescope folder created by Platform, always
UninstallFilesDir="{cf}\ASCOM\Uninstall\Telescope\EqPlatformAdapter"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Telescope\EqPlatformAdapter"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: ".\bin\Release\ASCOM.EqPlatformAdapter.exe"; DestDir: "{app}"
; Add driver assemblies into the ServedClasses folder
Source: ".\bin\Release\ASCOM.EqPlatformAdapter.Camera.dll"; DestDir: "{app}"
Source: ".\bin\Release\ASCOM.EqPlatformAdapter.Telescope.dll"; DestDir: "{app}"
...
Filename: "{app}\ASCOM.EqPlatformAdapter.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.EqPlatformAdapter.exe"; Parameters: "/unregister"
